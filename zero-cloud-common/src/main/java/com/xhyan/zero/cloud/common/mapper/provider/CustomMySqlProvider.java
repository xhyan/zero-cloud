package com.xhyan.zero.cloud.common.mapper.provider;

import com.xhyan.zero.cloud.common.mapper.helper.CustomSqlHelper;
...
/**
 * CustomMySqlProvider实现类，实现自定义扩展方法
 *
 * @author yanliwei
 */
public class CustomMySqlProvider extends MapperTemplate {

     public CustomMySqlProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
    ...
    public String replace(MappedStatement ms) {
        ...
        sql.append(CustomSqlHelper.replaceIntoTable(entityClass, tableName(entityClass)));
        sql.append(CustomSqlHelper.replaceColumns(entityClass, false, false, false));
    ...
    public String replaceIntoList(MappedStatement ms){
        ...
        StringBuilder sql = new StringBuilder();
        sql.append(CustomSqlHelper.replaceIntoTable(entityClass, tableName(entityClass)));
        sql.append(CustomSqlHelper.replaceColumns(entityClass, true, false, false));
        sql.append(" VALUES ");
